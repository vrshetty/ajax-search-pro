...
(function ($) {
    ...
    var methods = {
                                ...
                                if ( $this.o.show_more.action == "ajax") {
                                    ...
                                    if ($this.o.overridewpdefault) {
                                        if ( $this.o.override_method == "post") {
                                            ...
                                            var final = $this.o.homeurl + url + "&asp_active=1&p_asid=" + $this.o.id + "&p_asp_data=1&" + $('form', $this.n.searchsettings).serialize();
        ...
        settingsCheckboxToggle: function( $node ) {
            var $this = this;
            var $parent = $node;
